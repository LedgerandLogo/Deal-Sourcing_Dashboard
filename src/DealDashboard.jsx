...
export default function DealDashboard({ userId }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      <div style={{ background: '#fff', border: '1px solid #e5e5e5', borderRadius: 10, padding: '0.75rem 1.25rem', display: 'flex', alignItems: 'center', gap: 16, flexWrap: 'wrap' }}>
        <span style={{ fontSize: 13, fontWeight: 500, color: '#666' }}>Legal documents:</span>
        <a href="/legal/property-sourcing-agreement.pdf" target="_blank" rel="noopener noreferrer" style={{ fontSize: 13, color: '#1a3c5e', textDecoration: 'none' }}>Property Sourcing Agreement</a>
        <a href="/legal/finders-fee-commission-agreement.pdf" target="_blank" rel="noopener noreferrer" style={{ fontSize: 13, color: '#1a3c5e', textDecoration: 'none' }}>Finder's Fee & Commission Agreement</a>
        <a href="/legal/non-circumvention-agreement.pdf" target="_blank" rel="noopener noreferrer" style={{ fontSize: 13, color: '#1a3c5e', textDecoration: 'none' }}>Non-Circumvention Agreement</a>
      </div>
